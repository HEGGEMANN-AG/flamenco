...
#[derive(Clone, Debug)]
pub struct FullDirectoryInformation {
    pub file_index: u32,
...
impl QueryInformation for FullDirectoryInformation {
    fn class() -> DirectoryInformationClass {
        DirectoryInformationClass::FullDirectory
    }
